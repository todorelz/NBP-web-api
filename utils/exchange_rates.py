...
from .validators import _validate_currency_code,_validate_table, _validate_weekday,_validate_date_format
...
def get_exchange_rate_for_requested_days_period(table: Literal['A','C'],
    ...
    _validate_currency_code(code)
    _validate_table(table,['A','C'])
    start_date_dateformat = _validate_date_format(start_date)
    end_date_dateformat = _validate_date_format(end_date)
...
# do kazdej funkcji dodać dokstring (""" po enterze za końcu funkcji przed ":")